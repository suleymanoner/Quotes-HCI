  ...
  return (
    <View style={styles.container}>
      <View style={styles.top_container}>
        <Image source={{uri: user_img}} style={styles.image} />
      ...
      {post_image ? (
        <View style={styles.image_container}>
          <Image source={{uri: post_image}} style={styles.post_image} />
        </View>
      ) : null}

      <View style={styles.comment_like_container}>
        <TouchableOpacity onPress={() => onTapComment()}>
